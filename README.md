...
![Baking pankcakes](Gclust/Article/Bacon_Apple.PNG?raw = true)
...
![Alt text](./Article/CommunityDetection.png?raw = true)
...
![Alt text](./Article/Issue1.png?raw = true)
...
![Alt text](./Article/results1.png?raw = true)
...
![Alt text](./Article/Christmas.png?raw = true)
