...
![Baking pankcakes](Gclust/Article//Order_to_pancake.png?raw = true)
...
![Baking pankcakes](Gclust/Article/Clusters.png?raw = true)
...
![Baking pankcakes](Gclust/Article/MarketBasket_vs_Clustering.png?raw = true)
...
![Alt text](Gclust/Article/Jaccard.png?raw = true)
...
![Alt text](Gclust/Article/CommunityDetection.png?raw = true)
...
![Alt text](Gclust/Article/Issue1.png?raw = true)
...
![Alt text](Gclust/Article/results1.png?raw = true)
...
![Alt text](Gclust/Article/Christmas.png?raw = true)
